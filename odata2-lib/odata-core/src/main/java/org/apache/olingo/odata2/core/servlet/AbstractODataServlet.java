...
public abstract class AbstractODataServlet extends HttpServlet {
   ...
   */
  protected abstract ODataServiceFactory getServiceFactory(HttpServletRequest request);
...
//    resp.setStatus(HttpStatusCodes.NOT_IMPLEMENTED.getStatusCode());
   ...
   */
  protected ODataServiceFactory createODataServiceFactory(HttpServletRequest req)
   ...
   * @return instance of a ODataServiceFactory
   */
  protected ODataServiceFactory getServiceFactoryInstance(HttpServletRequest req) {
